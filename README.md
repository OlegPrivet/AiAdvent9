...
Инструменты всех включённых серверов доступны главному AI-агенту во всех чатах. AI выбирает и выполняет их автоматически; начало, завершение и ошибка каждого вызова отображаются в интерфейсе. На один раунд допускается до трёх вызовов и до двух раундов инструментов на один ответ. MCP дочерних агентов в этой версии не поддерживается.
